        ...
        compress: function () {
            ...
            switch (this.type) {
                ...
                case 'gcc':
                    ...
                    command = 'java -jar "' + __dirname + '/google_closure_compiler-r2388.jar" ' + fileInCommand.join(' ') + ' --language_in=' + (this.language || 'ECMASCRIPT3') + ' --js_output_file="' + this.fileOut + '" ' + this.options.join(' ');
                    break;
                case 'uglifyjs':
