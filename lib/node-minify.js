var minify = (function (undefined) {
    ...
    var minify = function (options) {
        ...
        this.tempFile = (options.tempPath || './') + new Date().getTime().toString() + '-' + uuid.v4();
    ...
    minify.prototype = minify.fn = {
        ...
        compress: function() {
            ...
            var prefix = (platform === 'win32') ? 'node ' : process.title + ' ';
            ...
            switch (this.type) {
                ...
                case 'clean-css':
                    ...
                    break;
                case 'csso':
                    command = prefix + '"' + __dirname + '/../node_modules/csso/bin/csso" -i "' + this.fileIn + '" -o "' + this.fileOut + '" ' + this.options.join(' ');
                    break;
