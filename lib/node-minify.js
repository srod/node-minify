var minify = (function(undefined) {
  ...
  minify.prototype = minify.fn = {
    ...
    compress: function() {
      ...
      var nodeModulesV3 = path.normalize(__dirname + '/../../');
      var isNPMv2 = dirExistsSync(nodeModulesV2);
      var dirToScan = isNPMv2 ? nodeModulesV2 : nodeModulesV3;
      var getPath = function(bin) {
        var binPath = glob.sync(dirToScan + '**/.bin/' + bin + ((platform === 'win32') ? '.cmd' : ''), {realpath: true})[0];
        if (!binPath) {
